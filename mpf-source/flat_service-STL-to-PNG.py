...
filenam = "pill"
fil = filenam + ".stl"
mesh = stl.StlMesh(fil,calculate_normals=False) #do not calculate normals automatically
...
whitepx = getRGBfromI(16777215) # max for 32bit is 2147483647, not using this anymore
